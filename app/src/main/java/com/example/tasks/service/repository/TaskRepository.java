...
public class TaskRepository extends BaseRepository {
    ...
    private void persist(Call<Boolean> call, final APIListeners<Boolean> listener) {
    ...
    public void create(TaskModel taskModel, final APIListeners<Boolean> listener) {
    ...
    public void update(TaskModel taskModel, final APIListeners<Boolean> listener) {
    ...
    public void delete(int id, final APIListeners<Boolean> listener) {
        Call<Boolean> call = this.mTaskService.delete(id);
        this.persist(call, listener);
    }

    public void complete(int id, final APIListeners<Boolean> listener) {
        Call<Boolean> call = this.mTaskService.complete(id);
        this.persist(call, listener);
    }

    public void undo(int id, final APIListeners<Boolean> listener) {
        Call<Boolean> call = this.mTaskService.undo(id);
        this.persist(call, listener);
    }

    private void list(Call<List<TaskModel>> call, final APIListeners<List<TaskModel>> listener) {
    ...
    public void all(final APIListeners<List<TaskModel>> listener) {
        Call<List<TaskModel>> call = this.mTaskService.all();
        this.list(call, listener);
    }

    public void nextWeek(final APIListeners<List<TaskModel>> listener) {
        Call<List<TaskModel>> call = this.mTaskService.nextWeek();
        this.list(call, listener);
    }

    public void overdue(final APIListeners<List<TaskModel>> listener) {
        Call<List<TaskModel>> call = this.mTaskService.overdue();
        this.list(call, listener);
    }

    public void load(int id, final APIListeners<TaskModel> listener) {
