...
public class TaskListViewModel extends AndroidViewModel {
    ...
    public void list(int filter) {
        this.mFilter = filter;
        APIListeners<List<TaskModel>> listener = new APIListeners<List<TaskModel>>() {
            @Override
    ...
    public void updateStatus(int id, boolean complete) {
        APIListeners<Boolean> listener = new APIListeners<Boolean>() {
            @Override
    ...
    public void delete(int id) {
        this.mTaskRepository.delete(id, new APIListeners<Boolean>() {
            @Override
            public void onSuccess(Boolean result) {
                list(mFilter);
